...
const PosterCard = memo(function PosterCard({ item, onPress }) {
  ...
  return (
    <YStack width={130} cursor="pointer" onPress={() => onPress(item)} pressStyle={{ opacity: 0.8 }} hoverStyle={{ scale: 1.03 }} animation="quick">
      <YStack width={130} aspectRatio={2 / 3} borderRadius={8} backgroundColor="#141A2E" overflow="hidden" position="relative">
        {poster
          ? <Image source={{ uri: poster }} style={FILL} resizeMode="cover" />
          : <YStack style={FILL} backgroundColor="#141A2E" />}
    ...
    <YStack paddingTop={20} paddingBottom={8} onLayout={handleLayout}>
      <XStack alignItems="baseline" justifyContent="space-between" paddingHorizontal={16} marginBottom={14}>
        <YStack cursor="pointer" onPress={() => onTitlePress?.(shelf.id, shelf.name)} pressStyle={{ opacity: 0.8 }}>
          <Text color="#fff" fontSize={20} fontWeight="700" letterSpacing={-0.3}>
            {shelf.name} <Text color="#6C5CE7" fontSize={16}>›</Text>
          </Text>
        </YStack>
      ...
      {shelf.items === null ? (
        ...
        >
          ...
          {shelf.loadingMore && <YStack width={60} justifyContent="center" alignItems="center"><Spinner size="small" color="#6C5CE7" /></YStack>}
        </ScrollView>
      )}
    </YStack>
  );
  ...
  return (
    <YStack flex={1} backgroundColor="#0A0E1A">
      <XStack alignItems="center" gap={12} paddingHorizontal={16} paddingTop={16} paddingBottom={10} borderBottomWidth={1} borderBottomColor="#28324E">
        <YStack paddingVertical={8} paddingHorizontal={12} backgroundColor="#1B2236" borderRadius={8} cursor="pointer" onPress={onBack} pressStyle={{ opacity: 0.8 }}>
      ...
      <Input margin={12} placeholder="Search titles..." placeholderTextColor="#555" value={search} onChangeText={setSearch} backgroundColor="#1B2236" color="#fff" borderRadius={10} paddingHorizontal={14} paddingVertical={10} fontSize={14} borderWidth={1} borderColor="#28324E" />
      {!displayed ? (
        ...
        <FlatList
          ...
          ListFooterComponent={(hasMore || loadingMore) ? <YStack alignItems="center" paddingVertical={20}><Spinner size="small" color="#6C5CE7" /></YStack> : null}
  ...
  if (loading) {
    return (
      <YStack flex={1} justifyContent="center" alignItems="center" backgroundColor="#0A0E1A" padding={24}>
        ...
        <Text color="#7A86A8" marginTop={12} fontSize={14}>Loading series...</Text>
      </YStack>
    );
  }
      ...
      <XStack gap={10} flexWrap="wrap">
        {discoverItems.map((pill, idx) => (
          <XStack
            ...
            pressStyle={{ opacity: 0.75 }} hoverStyle={{ borderColor: "#6C5CE7" }} animation="quick"
